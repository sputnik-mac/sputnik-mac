...
| [node-config/node-config](https://github.com/node-config/node-config) | [#896](https://github.com/node-config/node-config/pull/896) | fix: prevent setEnv from clobbering envConfig when merging N | ⏳ Open |
...
---
*Last updated: 2026-03-02 05:04 UTC*
